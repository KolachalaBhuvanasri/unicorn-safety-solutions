...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "JM Enterprises — Road Safety Starts With Quality" },
      { property: "og:description", content: "Manufacturer of speed humps, cones, reflective tapes, PPE and industrial safety products. Brand: UNICORN." },
